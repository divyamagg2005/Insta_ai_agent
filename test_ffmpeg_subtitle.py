#!/usr/bin/env python3
"""
Test script to verify FFmpeg subtitle command works correctly
"""
...
def test_ffmpeg_subtitle():
    ...
    try:
        ...
        print("✅ FFmpeg subtitle command completed successfully!")
